...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title text-semiold">Хостинг</h5>
    ...
    <div class="panel-body">
        <div class="jLoadData" data-href="<?= Yii::app()->urlManager->createUrl("project/internal/load", array('id' => $model->id, 'method' => 'hostingip')) ?>">
