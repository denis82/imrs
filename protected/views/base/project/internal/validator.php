...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-semiold">Валидатор разметки сайта</h5>
    </div>
    <div class="panel-body">
    	<p>Подключите Яндекс.Вебмастер в настройках сайта для получения данных от Валидатора микроразметки сайта</p>
    </div>
</div>
