...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-semiold">HTTP заголовки</h5>
    ...
    <div class="panel-body">
        <div class="jLoadData" data-href="<?= Yii::app()->urlManager->createUrl("project/internal/load", array('id' => $model->id, 'method' => 'serverheaders')) ?>">
...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-semiold">Robots</h5>
    ...
    <div class="panel-body" style="max-height: 300px; overflow: auto;">
        <div class="jLoadData" data-href="<?= Yii::app()->urlManager->createUrl("project/internal/load", array('id' => $model->id, 'method' => 'robots')) ?>">
            <span class="icon-spinner4 spinner"></span>
        </div>
    </div>
</div>
...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-semiold">Sitemap</h5>
        ...
        <div class="panel-body">
            <div class="jLoadData" data-href="<?= Yii::app()->urlManager->createUrl("project/internal/load", array('id' => $model->id, 'method' => 'sitemapinfo')) ?>">
                <span class="icon-spinner4 spinner"></span>
            </div>
        </div>
</div>
