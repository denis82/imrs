...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-semiold">Мобильная версия</h5>
    ...
    <div class="panel-body">
        <? if ($mobile): ?>
            <div class="alert alert-success alert-styled-left alert-bordered">
                <span class="text-semibold">Мобильная версия сайта</span> найдена по адресу <a href="<?= $mobile ?>" target="_blank"><?= $mobile ?></a><br>
            </div>
        <? else: ?>
            <div class="alert alert-danger alert-styled-left alert-bordered">
                <span class="text-semibold">Мобильная версия сайта</span> не найдена.
            </div>
        <? endif; ?>
    </div>
</div>
