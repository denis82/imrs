...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
    	...
    	if (count($tel) == 0):
	    	...
	    	<p>На сайте найдено <?= count($tel) ?> <?= Yii::t('app', 'номер телефона|номера телефона|номеров телефонов', count($tel)) ?>.</p>
	        ...
	        foreach ($tel as $link) {
	            ...
	            <div>
	                <a href="#" class="jUrl"><?= substr($link->href, 4) ?></a> 

	                <div class="panel panel-body block-result hide" data-href="<?= Yii::app()->urlManager->createUrl("project/usability/load", array('id' => $model->id, 'method' => 'tel', 'tel' => $link->href)) ?>">
