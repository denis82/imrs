...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-semiold">Упоминания домена</h5>
    ...
    <div class="panel-body">
        <div class="jLoadData" data-href="<?= Yii::app()->urlManager->createUrl("project/extlinks/load", array('id' => $model->id, 'method' => 'mention')) ?>">
