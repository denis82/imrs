...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-semiold">Орфография</h5>
    	...
    	if ($pages and count($pages)) {
    		...
    		?>
				<div class="alert alert-danger alert-styled-left alert-bordered">
					На страницах сайта есть орфографические ошибки.
				</div>
    		<?
    		...
    		foreach ($pages as $data) {
    			...
    			<div class="spell-result">
    				<a href="#" class="jPage"><?= $data->url ?></a>
    				<a href="<?= $data->url ?>" target="_blank"><i class="icon-redo2"></i></a>

    				<div class="panel panel-body block-result spell-text hide">
    					<?= nl2br( $data->short ) ?>
    				</div>
    			</div>
    			<?
    		...
    		?>
				<div class="alert alert-success alert-styled-left alert-bordered">
					На ваших страницах нет орфографических ошибок.
				</div>
    		<?
    	}
...
$(function(){
	$('.spell-result').each(function(){
		var $this = $(this);

		$('.jPage', $this).click(function(){
			$('.spell-text', $this).toggleClass('hide');
			return false;
		});
