 ...
 * @since 1.1
 */
class CAdminGridView extends CBaseListView {
    ...
    protected function createDataColumn($text) {
        ...
        $column = new CAdminDataColumn($this);
    ...
    public function renderPager() {
        ...
        if (!$this->enablePagination)
            return;
        $pager = array();
        $class = 'CAdminLinkPager';

        $pager['pages'] = $this->dataProvider->getPagination();
        if ($pager['pages']->getPageCount() > 1) {

            echo '<div class="row-fluid"><div class="span4"><div class="dataTables_info">';
            $this->renderSummary();
            echo '</div></div>';
            echo '<div class="span8"><div class="dataTables_paginate paging_bootstrap pagination">';
