 ...
 * @since 1.1
 */
class CAdminDataColumn extends CGridColumn {
    ...
    protected function renderHeaderCellContent() {
        ...
        if ($this->grid->enableSorting && $this->sortable && $this->name !== null) {
            echo $this->grid->dataProvider->getSort()->link($this->name, $this->header, array('class' => 'sort-link hide'));
    ...
    public function renderHeaderCell() {
        ...
        //TODO: Доработать
        $do = explode(" ", $this->grid->currentOrder);
        if ($do[0] == $this->name) {
            $direct = $do[1] == "desc" ? "desc" : "asc";
            $this->headerHtmlOptions['class'] = "sorting_$direct sort-link";
        } else {
            $this->headerHtmlOptions['class'] = 'sorting sort-link';
        }
        //$this->headerHtmlOptions['class'] = '';
