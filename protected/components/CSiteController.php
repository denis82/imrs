...
class CSiteController extends CController {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow authenticated users to access all actions                
                'actions' => array('login', 'logout', 'recovery', 'resetpassword'),
                'users' => array('?'),
            ),
            array('allow', // allow authenticated users to access all actions                
                'users' => array('@'),
    ...
    public function registerScripts() {
        ...
        */
        ...
        $this->clientScript->registerCssFile($this->assetsUrl . '/limitless_1.5/css/icons/fontawesome/styles.min.css');
        ...
        $this->clientScript->registerCssFile($this->assetsUrl . '/limitless_1.5/custom.css');
        ...
        $this->clientScript->registerScriptFile($this->assetsUrl . '/limitless_1.5/js/plugins/forms/selects/select2.min.js');
        ...
        $this->clientScript->registerScriptFile($this->assetsUrl . '/limitless_1.5/js/plugins/forms/selects/select2.min.js');
        $this->clientScript->registerScriptFile($this->assetsUrl . '/limitless_1.5/js/plugins/tables/datatables/datatables.min.js');
